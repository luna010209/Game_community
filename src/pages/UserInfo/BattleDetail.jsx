      ...
      <div className='d-flex p-2 align-items-center' style={{backgroundColor:"#E9E9E9"}}>
        ...
        <div className='col-6'>
          <div className="mb-1 d-flex w-100 position-relative" style={{ height: "45%", overflow: "hidden" }}>
            <div className="total-win" style={{ width: `${33 / (33 + 26) * 100}%` }}>
              <span>33</span>
            </div>
            <div className="total-lose" style={{ width: `${26 / (33 + 26) * 100}%` }}>
              <span>26</span>
            </div>
          ...
          <div className="mb-1 d-flex w-100 position-relative align-content-end" style={{ height: "45%", overflow: "hidden" }}>
            <div className="total-win" style={{ width: `${72349 / (72349 + 65028) * 100}%` }}>
              <span>72,349</span>
            </div>
            <div className="total-lose" style={{ width: `${65028 / (72349 + 65028) * 100}%` }}>
              <span>65,028</span>
            </div>
